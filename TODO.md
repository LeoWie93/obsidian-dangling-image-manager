...
#### "low-memory usage" Setting
- [ ] add lightswitch setting in the menu
	- needs info text "restart required"
- [ ] make initial parse and eventhandler registration optional
- [ ] start parse process on opening of modal
